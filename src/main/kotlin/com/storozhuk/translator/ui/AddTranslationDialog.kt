...
class AddTranslationDialog(val wordExplanation: WordExplanationData, val wordsService: WordsService) : Dialog() {
    init {
        ...
        val meaningField = TextField("Add meaning")
        val usageField = TextField("Add usage description (optional)")
        val exampleField = TextField("Add example (optional)")
        val exampleTranslatedField = TextField("Add example translated to your native language (optional)")
        ...
        val addButton = Button("Add") {
            if (meaningField.value.trim().isEmpty()) {
